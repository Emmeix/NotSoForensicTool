...
try:
	...
	if ask.lower() == 'y':
		os.system("pip3 install PyPDF2 psutil reportlab")
		import PyPDF2
		import psutil
		import platform
		from reportlab.pdfgen import canvas
...
def find_specific_files(folder, extension):
...
def search_files(folder, extension, keyword):
...
def find_modified_files(folder, date):
...
def word_difference(filename1, filename2):
	file1_set = set()
	file2_set = set()
